...
HT.Hexagon.prototype.draw = function (ctx) {
    ...
    DotNet.invokeMethodAsync("FleetCommander.App.Client", "ClientGameState.GetTokens", this.PathCoOrdY, this.PathCoOrdX).then(data => {

        if (data.length > 0) {
            var img = resources.get("img/testship.jpg");
            ctx.drawImage(img, this.MidPoint.X - 10, this.MidPoint.Y - 30, 20, 20);
        }
